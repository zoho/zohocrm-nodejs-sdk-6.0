...
class GetUsersUnavailability {
    ...
    static async getUsersUnavailabilityHours()
    {
        ...
        await paramInstance.add(ZOHOCRMSDK.UnavailabilityUsers.GetUsersUnavailabilityParam.GROUP_IDS, "347706109,34770610912");
        ...
        await paramInstance.add(ZOHOCRMSDK.UnavailabilityUsers.GetUsersUnavailabilityParam.TERRITORY_IDS, 31293800321221n);
        let filters = {};
