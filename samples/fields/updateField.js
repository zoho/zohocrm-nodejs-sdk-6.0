...
class UpdateField
{
    ...
    static async uploadField(layoutId, module, fieldId)
    {
        ...
        paramInstance.add(ZOHOCRMSDK.Fields.CreateFieldParam.MODULE, "Leads");
...
let layoutId = 3424322122n;
let module = "Leads";
let fieldId = 34324323543n;
await UpdateField.initialize();
await UpdateField.uploadField(layoutId, module, fieldId);