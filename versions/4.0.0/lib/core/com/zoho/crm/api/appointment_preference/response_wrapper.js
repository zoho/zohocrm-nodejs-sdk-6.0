...
class ResponseWrapper{
	 ...
	 */
	async setAppointmentPreferences(appointmentPreferences)	{
		const AppointmentPreference = (await (import("./appointment_preference.js"))).MasterModel;
		if((appointmentPreferences != null) && (!(appointmentPreferences instanceof AppointmentPreference)))	{
