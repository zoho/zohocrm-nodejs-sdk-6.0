...
class LicenseDetails{
	 ...
	 * @returns {number} A number representing the usersLicensePurchased
	 */
	 ...
	 * @param {number} usersLicensePurchased A number representing the usersLicensePurchased
	 */
	setUsersLicensePurchased(usersLicensePurchased)	{
		if((usersLicensePurchased != null) && (!(Object.prototype.toString.call(usersLicensePurchased) == "[object Number]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: usersLicensePurchased EXPECTED TYPE: number", null, null);
		}
	 ...
	 * @param {String} trialAction A String representing the trialAction
	 */
