...
class TransferTerritory{
	 ...
	 * @returns {BigInt} A BigInt representing the transferToId
	 */
	getTransferToId()	{
	 ...
	 * @param {BigInt} transferToId A BigInt representing the transferToId
	 */
	 ...
	 * @param {Boolean} deletePreviousForecasts A Boolean representing the deletePreviousForecasts
	 */
