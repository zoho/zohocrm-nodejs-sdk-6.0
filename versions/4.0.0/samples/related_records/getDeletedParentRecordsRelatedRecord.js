...
class GetDeletedParentRecordsRelatedRecord
{
    ...
    static async getDeletedParentRecordsRelatedRecord(moduleAPIName, recordId, relatedListAPIName)
    {
        ...
        await paramInstance.add(ZOHOCRMSDK.RecordsRelated.GetDeletedParentRecordsRelatedRecordParam.PAGE, 1);
        await paramInstance.add(ZOHOCRMSDK.RecordsRelated.GetDeletedParentRecordsRelatedRecordParam.PER_PAGE, 2);
        await paramInstance.add(ZOHOCRMSDK.RecordsRelated.GetDeletedParentRecordsRelatedRecordParam.FIELDS, "id");
        ...
        if (response != null)
        {
            ...
            if (responseHandler instanceof ZOHOCRMSDK.RecordsRelated.ResponseWrapper)
            {
            ...
            else if (responseHandler instanceof ZOHOCRMSDK.RecordsRelated.APIException) {
