...
class ModuleFields extends Fields{
	 ...
	 * @param {AutoNumber} autoNumber64 An instance of AutoNumber
	 */
	async setAutoNumber64(autoNumber64)	{
		const AutoNumber = (await (import("../fields/auto_number.js"))).MasterModel;
		if((autoNumber64 != null) && (!(autoNumber64 instanceof AutoNumber)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: autoNumber64 EXPECTED TYPE: AutoNumber", null, null);
		}
