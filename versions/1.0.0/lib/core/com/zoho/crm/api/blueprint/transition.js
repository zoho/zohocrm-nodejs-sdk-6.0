...
class Transition{
	 ...
	 * @returns {number} A number representing the sequence
	 */
	getSequence()	{
	 ...
	 * @param {number} sequence A number representing the sequence
	 */
	setSequence(sequence)	{
		if((sequence != null) && (!(Object.prototype.toString.call(sequence) == "[object Number]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: sequence EXPECTED TYPE: number", null, null);
		}
	 ...
	 * @param {number} percentPartialSave A number representing the percentPartialSave
	 */
	setPercentPartialSave(percentPartialSave)	{
		if((percentPartialSave != null) && (!(Object.prototype.toString.call(percentPartialSave) == "[object Number]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: percentPartialSave EXPECTED TYPE: number", null, null);
		}
	 ...
	 * @param {String} textColorCode A String representing the textColorCode
	 */
