...
class Users extends Record{
	 ...
	 * @returns {BigInt} A BigInt representing the phone
	 */
	getPhone()	{
	 ...
	 * @param {BigInt} phone A BigInt representing the phone
	 */
	setPhone(phone)	{
		if((phone != null) && (!(Object.prototype.toString.call(phone) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: phone EXPECTED TYPE: BigInt", null, null);
		}
	 ...
	 * @returns {BigInt} A BigInt representing the mobile
	 */
	getMobile()	{
	 ...
	 * @param {BigInt} mobile A BigInt representing the mobile
	 */
	setMobile(mobile)	{
		if((mobile != null) && (!(Object.prototype.toString.call(mobile) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: mobile EXPECTED TYPE: BigInt", null, null);
		}
