...
class Data extends Record{
	 ...
	 * @returns {ContactRole} An instance of ContactRole
	 */
	getContactRole()	{
	 ...
	 */
	async setContactRole(contactRole)	{
		const ContactRole = (await (import("./contact_role.js"))).MasterModel;
		if((contactRole != null) && (!(contactRole instanceof ContactRole)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: contactRole EXPECTED TYPE: ContactRole", null, null);
		}
