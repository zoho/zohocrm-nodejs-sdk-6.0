...
class ChartData{
	 ...
	 */
	async setColorPalette(colorPalette)	{
		const ButtonBackground = (await (import("./button_background.js"))).MasterModel;
		if((colorPalette != null) && (!(colorPalette instanceof ButtonBackground)))	{
