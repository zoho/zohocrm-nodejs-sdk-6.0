...
class GetRelatedRecordUsingExternalId{
    ...
    static async getRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue, destinationFolder) {
        ...
        await paramInstance.add(ZOHOCRMSDK.RecordsRelated.GetRelatedRecordUsingExternalIDParam.FIELDS, "id");
        let headerInstance = new ZOHOCRMSDK.HeaderMap();
        /* Possible parameters for Get Related Record operation */
        await headerInstance.add(ZOHOCRMSDK.RecordsRelated.GetRelatedRecordUsingExternalIDHeader.IF_MODIFIED_SINCE, new Date('June 15, 2020 05:35:32'));
        await headerInstance.add(ZOHOCRMSDK.RecordsRelated.GetRelatedRecordUsingExternalIDHeader.X_EXTERNAL, xExternal);
